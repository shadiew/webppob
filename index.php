...
<head>
    ...
    <link rel="stylesheet" href="mobile/styles/swiper-bundle.min.css">
...
<body>
        ...
        <div class="tf-container">
            <div class="tf-topbar d-flex justify-content-between align-items-center">
                <a class="user-info d-flex justify-content-between align-items-center" href="69_profile.html">
                    <img src="mobile/images/user/user1.jpg" alt="image">

                    <div class="content">
                        <h4 class="white_color"><?php echo $data_user['nama']; ?></h4>
                    ...
                    <div class="row">
                        <div class="col-6 br-right">
                            <div class="inner-left">
                                <p>Saldo Kamu:</p>
                                <h3>Rp.<b><?php echo number_format($data_user['saldo_top_up'], 0, ',', '.'); ?></b></h3>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="inner-right">
                                ...
                                <h3>
                                    ...
                                    <?php echo number_format($data_user['koin'],0,',','.'); ?>
                                    <span>Koin</span>
                                </h3>
                            </div>
                        </div>
    ...
    <div class="mt-5">
        <div class="tf-container">
            <div class="tf-title d-flex justify-content-between">
                ...
                <a href="46_bill.html" class="primary_color fw_6">View All</a>
            </div>
        ...
        <div class="tf-container">
            <ul class="tf-navigation-bar">
                <li class="active"><a class="fw_6 d-flex justify-content-center align-items-center flex-column"
                        href="<?php echo $config['web']['url'] ?>"><i class="icon-home2"></i> Home</a> </li>
                <li><a class="fw_4 d-flex justify-content-center align-items-center flex-column" href="58_history.html"><i
                            class="icon-history"></i> History</a> </li>
                <li><a class="fw_4 d-flex justify-content-center align-items-center flex-column" href="40_qr-code.html"><i
                            class="icon-scan-qr-code"></i> </a> </li>
                <li><a class="fw_4 d-flex justify-content-center align-items-center flex-column"
                        href="62_rewards.html"><svg width="25" height="24" viewBox="0 0 25 24" fill="none"
      ...
      <div class="modal-dialog modal-dialog-centered" role="document">
         <div class="modal-content">
            <div class="heading">
                ...
                <p class="fw_4 mt-2 text-center">Notifications may include alerts, sounds, and icon badges. These can be configure in Settings.</p>
            </div>
            <div class="bottom">
               <a href="#" class="secondary_color btn-hide-modal" data-dismiss="modal" aria-label="Close" >Don’t Allow</a>
               <a href="#" class="primary_color btn-hide-modal"  data-toggle="modal" onclick="read_news()" data-dismiss="modal" aria-label="Close"> Allow</a> 
            </a>
            </div>
         </div>
      </div>
   ...
   <?php } ?>
                            ...
                            <div class="noti-box">
                                ...
                                <div class="noti-list">
                                    ...
                                    <div class="content-right">
                                        <div class="title">
                                            <h3 class="fw_6"><?php echo $data_berita['title']; ?></h3>
                                            <span class="fw_6 on_surface_color"><?php echo tanggal_indo($data_berita['date']); ?></span>
                                        </div>
                                        <div class="desc">
                                            <p class="on_surface_color fw_4"><?php echo nl2br($beritasensor . "....."); ?></p>
                                            <i class="dot"></i>
                                        </div>
                                    </div>
                                </div>
        ...
        <div class="panel-box panel-down">
            ...
            <div class="wrap-transfer mb-5">
                <div class="tf-container">
                    ...
                    <a href="16_transfer-friend.html" class="action-sheet-transfer">
                    ...
                    <a href="23_transfer-bank.html" class="action-sheet-transfer">
            ...
            <div class="content-card mt-3 mb-5">
                <div class="tf-container">
                    <div class="tf-card-list bg_surface_color large out-line">
                        <div class="logo">
                            <img src="images/logo-banks/card-visa.png" alt="image">
                        </div>
                        <div class="info">
    ...
    <script type="text/javascript" src="mobile/javascript/swiper-bundle.min.js"></script>
    <script type="text/javascript" src="mobile/javascript/swiper.js"></script>
