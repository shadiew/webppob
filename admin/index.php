                    ...
                    <div class="row">
                      ...
                      <div class="col-6 text-end d-flex align-items-end justify-content-center">
                        <div class="card-body pb-0 pt-3 position-absolute bottom-0">
                          <img
                            src="<?php echo $config['web']['url'] ?>assets/img/illustrations/card-ratings-illustration.png"
                            alt="Ratings"
                            width="95" />
                        </div>
                      </div>
                  ...
                  <div class="card h-100">
                    <div class="row">
                      ...
                      <div class="col-6 text-end d-flex align-items-end justify-content-center">
                        <div class="card-body pb-0 pt-3 position-absolute bottom-0">
                          <img
                            src="<?php echo $config['web']['url'] ?>assets/img/illustrations/card-session-illustration.png"
                            alt="Ratings"
                            width="81" />
                        </div>
                      </div>
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="row">
                          ...
                          <div class="row">
                            ...
                            <div class="col-lg-5 col-md-3 col-12 order-1 order-md-2 my-2 my-md-0 text-center">
                              <img
                                src="<?php echo $config['web']['url'] ?>assets/img/products/card-weekly-sales-phone.png"
                                alt="weekly sales"
                                width="230"
                      ...
                      <div class="swiper-slide">
                        <div class="row">
                          ...
                          <div class="col-lg-5 col-md-3 col-12 order-1 order-md-2 my-2 my-md-0 text-center">
                            <img
                              src="<?php echo $config['web']['url'] ?>assets/img/products/card-weekly-sales-controller.png"
                              alt="weekly sales"
                              width="230"
                              class="weekly-sales-img" />
                          </div>
                      ...
                      <div class="swiper-slide">
                        <div class="row">
                          ...
                          <div class="col-lg-5 col-md-3 col-12 order-1 order-md-2 my-2 my-md-0 text-center">
                            <img
                              src="<?php echo $config['web']['url'] ?>assets/img/products/card-weekly-sales-watch.png"
                              alt="weekly sales"
                              width="230"
                              class="weekly-sales-img" />
                          </div>
                          ...
                          <div class="timeline-event">
                            ...
                            <div class="d-flex">
                              <a href="javascript:void(0)" class="me-3">
                                <img
                                  src="<?php echo $config['web']['url'] ?>assets/img/icons/misc/pdf.png"
                                  alt="PDF image"
                                  width="15"
                                  class="me-2" />
                          ...
                          <div class="timeline-event">
                            ...
                            <div class="d-flex flex-wrap align-items-center">
                              <div class="avatar avatar-sm me-3">
                                <img src="<?php echo $config['web']['url'] ?>assets/img/avatars/1.png" alt="Avatar" class="rounded-circle" />
                              </div>
                            ...
                            <table class="table table-borderless">
                              ...
                              <tbody>
                                <tr>
                                  <td class="ps-0">
                                    <img
                                      src="<?php echo $config['web']['url'] ?>assets//img/products/samsung-s22.png"
                                      alt="samsung"
                                      class="rounded"
                                      height="34" />
                                  </td>
                                ...
                                <tr>
                                  <td class="ps-0">
                                    <img
                                      src="<?php echo $config['web']['url'] ?>assets//img/products/apple-iPhone-13-pro.png"
                                      alt="iphone"
                                      class="rounded"
                                      height="34" />
                                  </td>
                                ...
                                <tr>
                                  <td class="ps-0">
                                    <img
                                      src="<?php echo $config['web']['url'] ?>assets//img/products/oneplus-9-pro.png"
                                      alt="us-flag"
                                      class="rounded"
                                      height="34" />
                                  </td>
                            ...
                            <table class="table table-borderless">
                              ...
                              <tbody>
                                <tr>
                                  <td class="ps-0">
                                    <img
                                      src="<?php echo $config['web']['url'] ?>assets//img/products/apple-mac-mini.png"
                                      alt="mac-mini"
                                      class="rounded"
                                      height="34" />
                                  </td>
                                ...
                                <tr>
                                  <td class="ps-0">
                                    <img
                                      src="<?php echo $config['web']['url'] ?>assets//img/products/hp-envy-x360.png"
                                      alt="hp-envy"
                                      class="rounded"
                                      height="34" />
                                  </td>
                                ...
                                <tr>
                                  <td class="ps-0">
                                    <img
                                      src="<?php echo $config['web']['url'] ?>assets//img/products/dell-inspiron-3000.png"
                                      alt="dell"
                                      class="rounded"
                                      height="34" />
                                  </td>
                            ...
                            <table class="table table-borderless">
                              ...
                              <tbody>
                                <tr>
                                  <td class="ps-0">
                                    <img
                                      src="<?php echo $config['web']['url'] ?>assets//img/products/sony-play-station-5.png"
                                ...
                                <tr>
                                  <td class="ps-0">
                                    <img
                                      src="<?php echo $config['web']['url'] ?>assets//img/products/xbox-series-x.png"
                                      alt="xbox"
                                      class="rounded"
                                      height="34" />
                                  </td>
                                ...
                                <tr>
                                  <td class="ps-0">
                                    <img
                                      src="<?php echo $config['web']['url'] ?>assets//img/products/nintendo-switch.png"
                                      alt="nintendo-switch"
                                      class="rounded"
                                      height="34" />
                                  </td>
                      ...
                      <div class="row d-flex align-items-center">
                        <div class="col-5 col-lg-6 col-xl-5">
                          <div
                            ...
                            data-color="primary"
                            data-series="70"
                            data-icon="<?php echo $config['web']['url'] ?>assets/img/icons/misc/card-icon-laptop.png"></div>
                        </div>
                      ...
                      <div class="row d-flex align-items-center">
                        <div class="col-5 col-lg-6 col-xl-5">
                          <div
                            ...
                            data-color="warning"
                            data-series="40"
                            data-icon="<?php echo $config['web']['url'] ?>assets/img/icons/misc/card-icon-bag.png"></div>
                        </div>
                        <div class="col-7 col-lg-6 col-xl-7">
                          <div class="card-info">
                            <div class="d-flex align-items-center gap-2 flex-wrap">
                    ...
                    <div class="swiper-wrapper">
                      <div class="swiper-slide pb-3">
                        ...
                        <div class="d-flex align-items-center mt-3">
                          <img
                            src="<?php echo $config['web']['url'] ?>assets//img/products/card-marketing-expense-logo.png"
                      ...
                      <div class="swiper-slide pb-3">
                        ...
                        <div class="d-flex align-items-center mt-3">
                          <img
                            src="<?php echo $config['web']['url'] ?>assets//img/products/card-accounting-logo.png"
                            alt="Marketing and sales"
                            width="84"
                            class="rounded" />
                          <div class="d-flex flex-column w-100 ms-4">
                      ...
                      <div class="swiper-slide pb-3">
                        ...
                        <div class="d-flex align-items-center mt-3">
                          <img
                            src="<?php echo $config['web']['url'] ?>assets//img/products/card-sales-overview-logo.png"
                            alt="Marketing and sales"
                            width="84"
                            class="rounded" />
                          <div class="d-flex flex-column w-100 ms-4">
